  ...
  if (!mounted) {
    return (
      <Button
        variant="ghost"
        size="icon"
        className="w-8 h-8 p-0 rounded-none border-0 bg-transparent shadow-none text-neutral-700 dark:text-neutral-200 hover:bg-transparent hover:text-neutral-900 dark:hover:text-neutral-100"
      >
