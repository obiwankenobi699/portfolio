...
export const SponsorHeartIcon = ({ className }: { className?: string }) => (
  <svg
    stroke="currentColor"
    fill="currentColor"
    strokeWidth="0"
          ...
          >
            <NeumorphButton className="px-4 sm:px-5 py-2.5">
              <div className="inline-flex items-center gap-2 text-sm font-medium text-neutral-700 dark:text-white">
                <SponsorHeartIcon className="translate-y-0 size-4.5 md:size-5 text-yellow-500 transition-transform duration-300" />
