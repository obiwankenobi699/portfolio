          ...
          <div className="prose dark:prose-invert max-w-none">
            <div className="text-base">
              <FadeIn delay={0.1} duration={0.5}>
                <div className="sm:px-12 py-1.5">
                  <div className="px-4 mb-3 sm:mb-4 pt-3 sm:pt-4">
                    <div className="mb-4 sm:mb-6">
                      <PageNavigation />
                    </div>
                    <h1 className="text-2xl sm:text-3xl font-[family-name:var(--font-hk-grotesk)] italic font-medium mb-4 text-neutral-900 dark:text-neutral-100 tracking-tight">
                      Blogs
                    </h1>
