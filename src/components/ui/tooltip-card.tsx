        ...
        <AnimatePresence>
          {isVisible && (
            <motion.div
              ...
              className={cn(
                "pointer-events-none fixed z-[2147483647] max-w-[90vw] rounded-2xl border border-neutral-200 bg-white shadow-[0_18px_45px_rgba(15,23,42,0.35)] dark:border-neutral-800 dark:bg-neutral-900 dark:shadow-[0_18px_45px_rgba(0,0,0,0.65)]",
