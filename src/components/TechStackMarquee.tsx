...
export default function TechStackMarquee({ className = "" }: TechStackMarqueeProps) {
  return (
    <div className={`w-full ${className}`}>
      ...
      <div className="mb-4">
        <h2 className="text-base font-[family-name:var(--font-hk-grotesk)] sm:text-xl mb-3 opacity-20 mt-4 sm:mt-6 -tracking-[0.01em]">
          Stack I use
        </h2>
      ...
      <div className="relative">
        ...
        <div className="absolute left-0 top-0 w-20 h-full bg-linear-to-r from-[var(--background)] dark:from-zinc-900 to-transparent pointer-events-none z-10" />
        <div className="absolute right-0 top-0 w-20 h-full bg-linear-to-l from-[var(--background)] dark:from-zinc-900 to-transparent pointer-events-none z-10" />
      </div>
    </div>
  );
}
